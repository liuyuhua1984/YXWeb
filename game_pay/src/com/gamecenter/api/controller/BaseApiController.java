...
import com.gamecenter.api.parBean.vo.Par_OperatorMsg;
import com.gamecenter.api.parBean.vo.Par_role;
...
public class BaseApiController {
	...
	public void init() {
		...
		ResourceBundle bundle = PropertyResourceBundle.getBundle("runApiConfig");
...
//		params.put("worldid", worldid);
		...
		List<OpGameworld> list = worldService.getWorldListByAppId(appid);
...
//		}
	...
	public Object recharge(HttpSession session, HttpServletResponse response, HttpServletRequest request) {
		...
		if (serverIps.size() > 0 && !serverIps.contains(ip)) {
			...
			// 参数验证
			String passport = "", flag = "", billno = "",appId="";
			int sid = 0, time = 0;
			int money = 0;
