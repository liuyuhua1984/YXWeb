...
public class WorldServiceImpl implements WorldService {
	...
	@Override
	public OpGameworld getWoldByAppIdAndWorldId(String appId, String worldid) {
		OpGameworldExample opGameworldExample = new OpGameworldExample();
		OpGameworldExample.Criteria query = opGameworldExample.createCriteria();
		query.andAppidEqualTo(appId);
		query.andWorldidEqualTo(worldid);
		List<OpGameworld> lists = opGameworldMapper.selectByExample(opGameworldExample);
		if (lists.size() > 0) {
			return lists.get(0);
		}
