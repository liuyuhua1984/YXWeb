package com.gamecenter.qqsdk.common.com.qq.open;
 ...
 * @History: 3.0.1 | coolinchen | 2013-01-16 12:01:05 | add report interface parameter 3.0.0 | nemozhang | 2012-03-21 12:01:05 | initialization
 * 
 */
public class SnsStat {
	...
	public static void statReport(long startTime, String serverName, HashMap<String, String> params, String method, String protocol, int rc, String scriptName) {
		...
		try {
			...
			// 转化为json
			String sendStr = String.format("{\"appid\":%s, \"pf\":\"%s\",\"rc\":%d,\"svr_name\":\"%s\", \"interface\":\"%s\",\"protocol\":\"%s\",\"method\":\"%s\",\"time\":%.4f,\"timestamp\":%d,\"collect_point\":\"sdk-java-v3\"}", params.get("appid"), params.get("pf"), rc, InetAddress.getByName(serverName).getHostAddress(), scriptName, protocol, method, timeCost, endTime / 1000);
