...
import com.gamecenter.qqsdk.common.com.qq.open.https.MySecureProtocolSocketFactory;
 ...
 * @History: 3.0.1 | coolinchen| 2012-11-07 11:20:12 | support POST request in "multipart/form-data" format 3.0.0 | nemozhang | 2012-03-21 12:01:05 | initialization
 * 
 */
...
public class SnsNetwork {
	 ...
	 * @throws OpensnsException 网络故障时抛出异常。
	 */
	public static String postRequestWithFile(String url, HashMap<String, String> params, HashMap<String, String> cookies, FilePart fp, String protocol) throws OpensnsException {
		if (protocol.equalsIgnoreCase("https")) {
			Protocol httpsProtocol = new Protocol("https", new MySecureProtocolSocketFactory(), 443);
			Protocol.registerProtocol("https", httpsProtocol);
		}
