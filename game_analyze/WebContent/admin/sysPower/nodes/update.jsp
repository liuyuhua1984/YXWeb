                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="position:relative;">
                                            <span style="margin-left:100px;width:25px;overflow:hidden;">
                                            <select style="width:175px;margin-left:-100px;position:absolute;"
                                                    onchange="this.parentNode.nextSibling.value=this.value.split('_')[0];$('#moduleName').val(this.value.split('_')[1]);">
