...
<body>
	...
	<div class="row-fluid container" style="width: 900px;">
		<article class="span12">
			...
			<div class="jarviswidget" id="widget-id-0">
				...
				<header>
					<h2>
						添加绑定玩家信息【<a href="${ctxPage}/agent/list">返回列表</a>】
					</h2>
				</header>
				<!-- 	wrap div -->
				<div>
					...
					<div class="inner-spacer">
						...
						<fieldset>
							...
							<div class="control-group">
								<label class="control-label" for="playerId">玩家ID</label>

								<div class="controls">
									<input type="number"  id="playerId" name="playerId" value="1" placeholder="请填写你的游戏玩家ID" />
								</div>
							</div>
								<!-- 
							<div class="control-group">
	...
	<script type="text/javascript">
		...
		function saveMsg() {
			...
			$.ajax({
				url : "${ctxPage}/agent/match/playerId",
				type : 'POST',
				...
				success : function(data) {
					if (data.res == "1") {
						alert('修改成功！');
						//location.reload();
						window.location.href="${ctxPage}/agent/list";
					} else if (data.res == "-3"){
						alert('游戏玩家不存在！');
					} else if (data.res == "-2"){
						alert('此代理不存在！');
