                ...
                <div class="inner-spacer">
                    ...
                    <table class="table table-striped table-bordered responsive"
                        ...
                        <tr>
                            ...
                            <th width="120" style="background-color: #ffd700">对于区服</th>
                            <th width="80" style="background-color: #ffd700">状态</th>
                            <th width="120" style="background-color: #ffd700">开始时间</th>
                            <th width="80" style="background-color: #ffd700">参与次数</th>
                            <th width="80" style="background-color: #ffd700">卡密数量</th>
                            <th width="80" style="background-color: #ffd700">使用数量</th>
