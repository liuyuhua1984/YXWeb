...
<div class="row-fluid" style="margin-top: 0px; width: 500px; margin-left: 3px; float: left">
...
<div class="row-fluid" style="margin-top: 0px; width: 500px; margin-left: 3px; float: left">
    <article class="span12">
        ...
        <div class="jarviswidget" id="widget-id-7">
            <header>
                <h2>等级范围分布 <span id="msg3" style="color: #ff0000;"></span></h2>
            </header>
            <!-- wrap div -->
            <div>
    ...
    function gradescope() {
        ...
        $.ajax({
            ...
            success: function (data) {
                drawPic(data.datascope, data.title);
            }
        });
    }
    //绘图
