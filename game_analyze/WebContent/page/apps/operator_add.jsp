                ...
                <div class="inner-spacer">
                    ...
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="opcode">运营商代码</label>

                            <div class="controls">
                                <input type="text" class="span12" id="opcode" name="opcode"
                                       value="${opOperator.opcode}"/>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="optname">运营商名称</label>

                            <div class="controls">
                                <input type="text" class="span12" id="optname" name="optname"
                                       value="${opOperator.optname}"/>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="optname">状态</label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="span12" id="info" rows="3" name="info">${opOperator.info}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-actions" style="text-align: left;">
                            ...
                            <input name="optid" value="${opOperator.optid}" type="hidden">
                        </div>
                    </fieldset>
                    </form>
                </div>
