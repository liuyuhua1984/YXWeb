...
(function(g, h) {
    ...
    if (g.$ === h)g.$ = f;
    f.fn = f.prototype = {constructor:function(a, c) {
        var d,c = c || document;
        if (!a)return this;
        ...
        return{left:c.left + (self.pageXOffset || d.scrollLeft) - (d.clientLeft || a.clientLeft || 0),top:c.top + (self.pageYOffset || d.scrollTop) - (d.clientTop || a.clientTop || 0)}
    },html:function(a) {
        var c = this[0];
...
(function(g, h, i) {
    ...
    e.version = "5.0";
    e.fn = e.prototype = {constructor:function(b) {
        var a;
        this.closed = !1;
        this.config = b;
        ...
        title:function(b) {
            ...
            f.css({zIndex:i,position:"fixed",left:0,top:0,width:"100%",height:"100%",overflow:"hidden"}).addClass("d-mask");
