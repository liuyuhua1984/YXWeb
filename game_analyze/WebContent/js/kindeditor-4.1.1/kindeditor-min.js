/* KindEditor 4.1.1 (2012-06-10), Copyright (C) kindsoft.net, Licence: http://www.kindsoft.net/license.php */
(function (z, k) {
    function V(a) {
        if (!a)return!1;
    ...
    function n(a, b) {
        if (V(a))for (var c = 0, d = a.length; c < d; c++) {
    ...
    function u(a, b) {
        var b = b === k ? "," : b, c = {}, d = V(a) ? a : a.split(b), e;
        n(d, function (a, b) {
    ...
    function X(a, b, c) {
        if (b.indexOf(",") >= 0)n(b.split(","), function () {
            X(a, this, c)
        }); else {
            var d = a[W] || null;
            d || (a[W] = ++gb,d = gb);
    ...
    function da(a, b, c) {
        if (b && b.indexOf(",") >= 0)n(b.split(","), function () {
            da(a, this, c)
        }); else {
            var d = a[W] || null;
            if (d)if (b === k)d in v && (n(v[d],
                    function (b, c) {
                        b != "el" && c.length > 0 && oa(a, b, c[0])
                    }),delete v[d],fb(a)); else if (v[d]) {
                var e = v[d][b];
                if (e && e.length > 0) {
                    c === k ? (oa(a, b, e[0]),delete v[d][b]) : (n(e, function (a, b) {
    ...
    function pa(a, b, c, d) {
        ...
        if (d === k)var h = location.pathname.match(/^(\/.*)\//), d = h ? h[1] : "";
        var f;
        if (f = /^(\w+:\/\/[^\/]*)/.exec(a)) {
            if (f[1] !== c)return a
        } else if (/^\w+:/.test(a))return a;
        /^\//.test(a) ? a = c + e(a.substr(1)) : /^\w+:\/\//.test(a) ||
                (a = c + e(d + "/" + a));
    ...
    function Q(a, b, c, d, e) {
        ...
        var f = [], a = a.replace(/([ \t\n\r]*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>([ \t\n\r]*)/g, function (a, m, r, s, qa, D, G) {
            var m = m || "", r = r || "", k = s.toLowerCase(), l = qa || "",
                    s = D ? " " + D : "", G = G || "";
            if (b && !h[k])return"";
            s === "" && ib[k] && (s = " /");
            jb[k] && (m && (m = " "),G && (G = " "));
            ...
            d && k == "br" && (G = "\n");
            if (kb[k] && !Ha[k])if (d) {
                r && f.length > 0 && f[f.length - 1] === k ? f.pop() : f.push(k);
                G = m = "\n";
                qa = 0;
                for (D = r ? f.length : f.length - 1; qa < D; qa++)m += e,r || (G += e);
                s ? f.pop() : r || (G += e)
            } else m = G = "";
            if (l !== "") {
                var w = J(a);
                ...
                n(w, function (a, d) {
                    Tb[a] && (w[a] = a);
                    L(a, ["src", "href"]) >= 0 && (w[a] = pa(d, c));
                    (b && a !== "style" && !h[k]["*"] && !h[k][a] || k === "body" && a === "contenteditable" || /^kindeditor_\d+$/.test(a)) && delete w[a];
                    if (a === "style" && d !== "") {
                        var e = ea(d);
                        n(e, function (a) {
                            b && !h[k].style && !h[k]["." + a] && delete e[a]
                        });
                        var g = "";
                        n(e, function (a, b) {
                            g += a + ":" + b + ";"
    ...
    function lb(a, b) {
        a = a.replace(/<meta[\s\S]*?>/ig, "").replace(/<![\s\S]*?>/ig, "").replace(/<style[^>]*>[\s\S]*?<\/style>/ig,
                "").replace(/<script[^>]*>[\s\S]*?<\/script>/ig, "").replace(/<w:[^>]+>[\s\S]*?<\/w:[^>]+>/ig, "").replace(/<o:[^>]+>[\s\S]*?<\/o:[^>]+>/ig, "").replace(/<xml>[\s\S]*?<\/xml>/ig, "").replace(/<(?:table|td)[^>]*>/ig, function (a) {
    ...
    function ob(a, b) {
        var c = b.width, d = b.height, e = b.type || mb(b.src), g = Ia(b), h = "";
        c > 0 && (h += "width:" + c + "px;");
        d > 0 && (h += "height:" + d + "px;");
    ...
    function ua(a, b) {
        ...
        function e(a, b, c) {
            var e = [];
            (a = (c.ownerDocument || c).getElementById(a.replace(/\\/g, ""))) && d(b, a.nodeName) && sa(c, a) && e.push(a);
            return e
        }
        ...
        function g(a, b, c) {
            ...
            if (c.getElementsByClassName) {
                ...
                h = 0;
                for (f = e.length; h < f; h++)i = e[h],sa(c, i) && g.push(i)
            } else {
        ...
        function h(a, b, d, e) {
            for (var g = [], d = e.getElementsByTagName(d), h = 0, f = d.length; h < f; h++)e = d[h],e.nodeType == 1 && (b === null ? ta(e, a) !== null && g.push(e) : b === c(ta(e, a)) && g.push(e));
            return g
        }

        function f(a, b) {
            var c = [], i, j = (i = /^((?:\\.|[^.#\s\[<>])+)/.exec(a)) ? i[1] : "*";
            if (i = /#((?:[\w\-]|\\.)+)$/.exec(a))c = e(i[1], j, b); else if (i = /\.((?:[\w\-]|\\.)+)$/.exec(a))c = g(i[1], j, b); else if (i = /\[((?:[\w\-]|\\.)+)\]/.exec(a))c =
                    h(i[1].toLowerCase(), null, j, b); else if (i = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(a)) {
                c = i[1].toLowerCase();
                i = i[2];
                if (c === "id")j = e(i, j, b); else if (c === "class")j = g(i, j, b); else if (c === "name") {
                    c = [];
                    i = (b.ownerDocument || b).getElementsByName(i.replace(/\\/g, ""));
                    for (var m, s = 0, r = i.length; s < r; s++)m = i[s],d(j, m.nodeName) && sa(b, m) && m.getAttributeNode("name") && c.push(m);
                    j = c
                } else j = h(c, i, j, b);
                c = j
            } else {
                ...
                m = 0;
                for (s = j.length; m < s; m++)i = j[m],i.nodeType == 1 && c.push(i)
            }
            return c
        }
        ...
        if (j.length > 1) {
            var m = [];
            n(j, function () {
                n(ua(this, b), function () {
                    L(this, m) < 0 && m.push(this)
                })
            });
            return m
        }
        for (var b = b || document, j = [], r, s = /((?:\\.|[^\s>])+|[\s>])/g; r = s.exec(a);)r[1] !== " " && j.push(r[1]);
        r = [];
        if (j.length == 1)return f(j[0], b);
        var s = !1, k, D, l, o, p, w, ra, H, q, t;
        w = 0;
        for (lenth = j.length; w < lenth; w++)if (k = j[w],k === ">")s = !0; else {
            if (w > 0) {
                D = [];
                ra = 0;
                for (q = r.length; ra < q; ra++) {
                    o = r[ra];
                    l = f(k, o);
                    H = 0;
                    for (t = l.length; H < t; H++)p = l[H],s ? o === p.parentNode && D.push(p) : D.push(p)
                }
                r = D
            } else r = f(k, b);
            if (r.length ===
    ...
    function Ma(a, b, c) {
        function d(d, e, g) {
            ...
            if (c) {
                var m = d;
                e > 0 && (m = d.splitText(e),a.setStart(d, e));
                g < h && (d = m.splitText(g - e),a.setEnd(d, 0));
                f.push(m)
            }
            return j
        }
        ...
        function g(e, k) {
            for (var l = e.firstChild, o; l;) {
                o = (new M(h)).selectNode(l);
                m = o.compareBoundaryPoints(fa, a);
                m >= 0 && r <= 0 && (r = o.compareBoundaryPoints(ga, a));
                r >= 0 && s <= 0 && (s = o.compareBoundaryPoints($, a));
                s >= 0 && n <= 0 && (n = o.compareBoundaryPoints(ha, a));
                if (n >= 0)return!1;
                o = l.nextSibling;
                if (m > 0)if (l.nodeType == 1)if (r >= 0 && s <= 0)b && k.appendChild(l.cloneNode(!0)),c && f.push(l); else {
                    var D;
                    b && (D = l.cloneNode(!1),k.appendChild(D));
                    if (g(l, D) === !1)return!1
                } else if (l.nodeType == 3 && (l = l == j.startContainer ? d(l, j.startOffset, l.nodeValue.length) :
                        l == j.endContainer ? d(l, 0, j.endOffset) : d(l, 0, l.nodeValue.length),b))try {
                    k.appendChild(l)
                } catch (G) {
                }
                l = o
        ...
        var h = a.doc, f = [], j = a.cloneRange().down(), m = -1, r = -1, s = -1, n = -1, k = a.commonAncestor(), l = h.createDocumentFragment();
        if (k.nodeType == 3)return k = d(k, a.startOffset, a.endOffset),b && l.appendChild(k),e(),b ? l : a;
        g(k, l);
        c && a.up().collapse(!0);
    ...
    function qb(a, b) {
        ...
        var h = c, i = 0, j = -1, m = a.duplicate();
        ia(m, e);
        for (var k = 0, s = g.length; k < s; k++) {
            var l = g[k], j = m.compareEndPoints("StartToStart", d);
            if (j === 0)return{node:l.parentNode, offset:k};
            if (l.nodeType == 1) {
                var n = a.duplicate(), o, p = f(l), q = l;
                p.isControl() && (o = c.createElement("span"),
                        p.after(o),q = o,i += p.text().replace(/\r\n|\n|\r/g, "").length);
                ia(n, q);
                m.setEndPoint("StartToEnd", n);
                j > 0 ? i += n.text.replace(/\r\n|\n|\r/g, "").length : i = 0;
                o && f(o).remove()
            } else l.nodeType == 3 && (m.moveStart("character", l.nodeValue.length),i += l.nodeValue.length);
            j < 0 && (h = l)
        }
        if (j < 0 && h.nodeType == 1)return{node:e, offset:f(e.lastChild).index() + 1};
    ...
    function sb(a) {
        ...
        var c;
        if (o) {
            if (a.item)return c = Y(a.item(0)),c = new M(c),c.selectNode(a.item(0)),c;
    ...
    function Sa(a) {
        var b = a.moveEl, c = a.moveFn, d = a.clickEl || b, e = a.beforeDrag, g = [document], h = [
            {x:0, y:0}
        ], i = [];
        (a.iframeFix === k || a.iframeFix) && f("iframe").each(function () {
            var a;
            try {
                a = Ta(this),f(a)
            } catch (b) {
        ...
        d.mousedown(function (a) {
            var m = d.get(), k = t(b.css("left")), s =
                    t(b.css("top")), l = b.width(), o = b.height(), p = a.pageX, q = a.pageY, u = !0;
            e && e();
            n(g, function (a, b) {
                function e(b) {
                    if (u) {
                        var g = O(h[a].x + b.pageX - p), f = O(h[a].y + b.pageY - q);
                        c.call(d, k, s, l, o, g, f)
                    }
                    b.stop()
                }
                ...
                f(b).mousemove(e).mouseup(j).bind("selectstart", g);
                i.push({doc:b, move:e, up:j, select:g})
            });
            m.setCapture &&
            m.setCapture()
        })
    ...
    function Yb(a, b, c, d) {
        var e = [Va === "" ? "<html>" : '<html dir="' + Va + '">', '<head><meta charset="utf-8" /><title></title>', "<style>", "html {margin:0;padding:0;}", "body {margin:0;padding:5px;}", 'body, td {font:12px/1.5 "sans serif",tahoma,verdana,helvetica;}', "body, p, div {word-wrap: break-word;}", "p {margin:5px 0;}", "table {border-collapse:collapse;}", "img {border:0;}",
    ...
    function Ya(a, b) {
        var c = document.getElementsByTagName("head")[0] || (S ? document.body : document.documentElement), d = document.createElement("script");
        c.appendChild(d);
        d.src = a;
        d.charset = "utf-8";
    ...
    function Za(a) {
        for (var b = document.getElementsByTagName("head")[0] ||
                (S ? document.body : document.documentElement), c = document.createElement("link"), d = Fb(pa(a, "absolute")), e = f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)if (Fb(pa(e[g].href, "absolute")) === d)return;
        b.appendChild(c);
        c.href = a;
        c.rel = "stylesheet"
    }
        ...
        f(a.edit.doc).contextmenu(function (b) {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    var c = 0, d = [];
                    for (n(a._contextmenus, function () {
                    ...
                    if (d.length > 0) {
                        b.preventDefault();
                        var g = f(a.edit.iframe).pos(), h = Xa({x:g.x + b.clientX, y:g.y + b.clientY, width:c, css:{visibility:"hidden"}, shadowMode:a.shadowMode});
                        n(d, function () {
                            this.title &&
                            h.addItem(this)
                        });
    ...
    function bc() {
        ...
        f(a.edit.textarea[0], a.edit.win).focus(
                function (b) {
                    a.afterFocus && a.afterFocus.call(a,
                            b)
                }).blur(function (b) {
    ...
    function Kb(a, b) {
        ...
        c.designMode ? (e = this.cmd.range,g = e.createBookmark(!0),g.html =
                d.innerHTML) : g = {html:d.innerHTML};
        Jb(b, g);
        var h = a.pop();
    ...
    function Lb(a, b) {
        ...
        if (d = f(a)) {
            ...
            Ya(e.langPath + e.langType +
                    ".js?ver=" + encodeURIComponent(f.DEBUG ? Ba : Ca), function () {
                c(e)
            });
            return e
        }
    ...
    if (!z.KindEditor) {
        ...
        var Ca = "4.1.1 (2012-06-10)", p = navigator.userAgent.toLowerCase(), o = p.indexOf("msie") > -1 && p.indexOf("opera") == -1, ka = p.indexOf("gecko") > -1 && p.indexOf("khtml") == -1, ba = p.indexOf("applewebkit") > -1, La = p.indexOf("opera") > -1, cc = p.indexOf("mobile") > -1, dc = /ipad|iphone|ipod/.test(p), S = document.compatMode != "CSS1Compat", B = (p = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(p)) ?
                p[1] : "0", Ba = (new Date).getTime(), O = Math.round, f = {DEBUG:!1, VERSION:Ca, IE:o, GECKO:ka, WEBKIT:ba, OPERA:La, V:B, TIME:Ba, each:n, isArray:V, isFunction:bb, inArray:L, inString:ma, trim:A, addUnit:q, removeUnit:t, escape:C, unescape:Ea, toCamel:ca, toHex:na, toMap:u, toArray:Fa, undef:l, invalidUrl:function (a) {
            return!a || /[<>"]/.test(a)
        }, addParam:function (a, b) {
            return a.indexOf("?") >= 0 ? a + "&" + b : a + "?" + b
        }, extend:F, json:cb}, jb = u("a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
        ...
        f.options = {designMode:!0, fullscreenMode:!1, filterMode:!0, wellFormatMode:!0, shadowMode:!0, loadStyleMode:!0,
            basePath:f.basePath, themesPath:f.basePath + "themes/", langPath:f.basePath + "lang/", pluginsPath:f.basePath + "plugins/", themeType:"default", langType:"zh_CN", urlType:"", newlineTag:"p", resizeType:2, syncType:"form", pasteType:2, dialogAlignType:"page", useContextmenu:!0, fullscreenShortcut:!0, bodyClass:"ke-content", indentChar:"\t", cssPath:"", cssData:"", minWidth:650, minHeight:100, minChangeSize:5, items:["source", "|", "undo", "redo", "|", "preview", "print", "template", "code", "cut", "copy", "paste", "plainpaste", "wordpaste",
            ...
            ], fontSizeTable:["9px", "10px", "12px", "14px", "16px", "18px", "24px", "32px"], htmlTags:{font:["color", "size", "face", ".background-color"], span:[".color", ".background-color", ".font-size", ".font-family", ".background", ".font-weight", ".font-style",
                ...
                ".border"], "p,ol,ul,li,blockquote,h1,h2,h3,h4,h5,h6":["align", ".text-align", ".color", ".background-color", ".font-size", ".font-family", ".background", ".font-weight", ".font-style", ".text-decoration", ".vertical-align", ".text-indent", ".margin-left"], pre:["class"], hr:["class", ".page-break-after"], "br,tbody,tr,strong,b,sub,sup,em,i,u,strike,s,del":[]}, layout:'<div class="container"><div class="toolbar"></div><div class="edit"></div><div class="statusbar"></div></div>'};
        var db = !1, Ob = u("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"),
                p = u("33..40"), ab = {};
        n(Ob, function (a, b) {
            ab[a] = b
        });
        ...
        F(eb, {init:function (a, b) {
            ...
            if (!c.which && c.button !== k)c.which = c.button & 1 ? 1 : c.button & 2 ? 3 : c.button & 4 ? 2 : 0;
            switch (c.which) {
                case 186:
                    c.which = 59;
                    break;
        ...
        var W = "kindeditor_" + Ba, gb = 0, v = {};
        o && z.attachEvent("onunload", function () {
            n(v, function (a, b) {
                b.el && da(b.el)
            })
        });
        ...
        f.ready = function (a) {
            ...
            var e = !1;
            if (document.addEventListener)X(document, "DOMContentLoaded", b); else if (document.attachEvent) {
        ...
        f.queryAll = ua;
        F(E, {init:function (a) {
            for (var a = V(a) ? a : [a], b = 0, c = 0, d = a.length; c < d; c++)a[c] && (this[c] = a[c].constructor === E ? a[c][0] : a[c],
                    b++);
            this.length = b;
            this.doc = Y(this[0]);
            this.name = Ka(this[0]);
            ...
            var c = this;
            if (a === k)return J(c.outer());
            if (typeof a === "object")return n(a, function (a, b) {
                c.attr(a, b)
            }),c;
            if (b === k)return b = c.length < 1 ? null : ta(c[0], a),b === null ? "" : b;
            c.each(function () {
                Ja(this, a, b)
            });
            return c
            ...
            return this.css("width", q(a))
        }, height:function (a) {
            if (a === k) {
                if (this.length < 1)return 0;
                return this[0].offsetHeight
            }
            return this.css("height", q(a))
        }, opacity:function (a) {
            this.each(function () {
                this.style.opacity === k ? this.style.filter = a == 1 ? "" : "alpha(opacity=" + a * 100 + ")" : this.style.opacity = a == 1 ? "" : a
            });
            return this
        },
            data:function (a, b) {
                if (b === k)return this._data[a];
                this._data[a] = b;
                return this
            }, pos:function () {
                ...
                return this.css("display", a === k ? "block" : a)
            }, hide:function () {
                ...
                if (this.length < 1)return new E([]);
                for (var a = [], b = this[0].firstChild; b;)(b.nodeType !=
                        3 || A(b.nodeValue) !== "") && a.push(b),b = b.nextSibling;
                return new E(a)
            }, first:function () {
                var a = this.children();
                ...
                if (!(this.length < 1))return b = b === k ? !0 : b,c(this[0]),this
            }});
        n("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error,contextmenu".split(","), function (a, b) {
        ...
        F(M, {init:function (a) {
            ...
            if (o) {
                ...
                if (c !== 0)return c;
                var g, h, i, j;
                if (a === ga || a === ha)g = this.startContainer,i = this.startOffset;
                if (a === fa || a === $)g = this.endContainer,i = this.endOffset;
                if (a === ga || a === fa)h = b.startContainer,j = b.startOffset;
                if (a === $ || a === ha)h = b.endContainer,j = b.endOffset;
                if (g ===
                        h)return g = i - j,g > 0 ? 1 : g < 0 ? -1 : 0;
            ...
            b.nodeType == 1 ? (i = b.childNodes[c]) ? (b.insertBefore(a, i),b === d && (e += j)) : b.appendChild(a) : b.nodeType == 3 && (c === 0 ? (b.parentNode.insertBefore(a,
                    b),b.parentNode === d && (e += j)) : c >= b.nodeValue.length ? b.nextSibling ? b.parentNode.insertBefore(a, b.nextSibling) : b.parentNode.appendChild(a) : (i = c > 0 ? b.splitText(c) : b,b.parentNode.insertBefore(a, i),b === d && (d = i,e -= c)));
            ...
            b.setEndPoint("StartToStart",
                    rb(a.startContainer, a.startOffset));
        ...
        F(va, {init:function (a) {
            ...
            var a =
                    l(a, !0), b = this.sel, c = this.range.cloneRange().shrink(), d = c.startContainer, e = c.startOffset, g = Y(d), h = this.win, i, j = !1;
            if (a && d.nodeType == 1 && c.collapsed) {
                ...
                if (ba && (a = d.childNodes,f(d).isInline() || e > 0 && f(a[e - 1]).isInline() || a[e] && f(a[e]).isInline()))c.insertNode(g.createTextNode("\u200b")),j = !0
            }
            if (o)try {
                i = c.get(!0),i.select()
            } catch (k) {
            } else j &&
                    c.collapse(!1),i = c.get(!0),b.removeAllRanges(),b.addRange(i);
            h.focus();
            return this
        }, wrap:function (a) {
            var b = this.range, c;
            ...
            f(a).scan(function (a) {
                if (!g && a == e.start)g = !0; else if (g) {
                    ...
                    if (!xb(b) && b.type == 3 && A(a.nodeValue).length > 0) {
                        ...
                        d = c;
                        d = d.clone(!0);
                        if (b.type == 3)Ra(d).append(b.clone(!1)),b.replaceWith(d); else {
                            for (var a = b, m; (m = b.first()) && m.children().length == 1;)b = m;
                            m = b.first();
                            for (b = b.doc.createDocumentFragment(); m;)b.appendChild(m[0]),m = m.next();
                            m = a.clone(!0);
                            for (var k = Ra(m), l = m, n = !1; d;) {
                                for (; l;)l.name === d.name && (Xb(l, d.attr(), d.css()),n = !0),l = l.first();
                                n || k.append(d.clone(!1));
                                n = !1;
                                d = d.first()
                            }
                            d = m;
            ...
            for (var c = this.range, d = c.doc, e = c.cloneRange().collapse(a), g = e.startContainer, h = e.startOffset, i = g.nodeType == 3 ? g.parentNode : g, j = !1, m; i && i.parentNode;) {
                m = f(i);
                if (b) {
                    if (!m.isStyle())break;
                    if (!Pa(m, b))break
                } else if (Da[m.name])break;
                j = !0;
                i = i.parentNode
            }
            if (j)d = d.createElement("span"),c.cloneRange().collapse(!a).insertNode(d),a ? e.setStartBefore(i.firstChild).setEnd(g, h) : e.setStart(g, h).setEndAfter(i.lastChild),g = e.extractContents(),
                    h = g.firstChild,j = g.lastChild,a ? (e.insertNode(g),c.setStartAfter(j).setEndBefore(d)) : (i.appendChild(g),c.setStartBefore(d).setEndBefore(h)),e = d.parentNode,e == c.endContainer && (i = f(d).prev(),g = f(d).next(),i && g && i.type == 3 && g.type == 3 ? c.setEnd(i[0], i[0].nodeValue.length) : a || c.setEnd(c.endContainer, c.endOffset - 1)),e.removeChild(d);
            return this
        }, remove:function (a) {
            ...
            if (c.collapsed) {
                ...
                b = c.startContainer;
                d = c.startOffset;
                if (d > 0 && (e = f(b.childNodes[d - 1])) && aa(e))e.remove(),c.setStart(b, d - 1);
                (d = f(b.childNodes[d])) && aa(d) && d.remove();
            ...
            if (d > 0) {
                ...
                l && aa(l) && (l.remove(),c.setStart(b, d - 1),b == e && c.setEnd(e, m - 1));
                if ((d = f(b.childNodes[d])) && aa(d))d.remove(),b == e && c.setEnd(e, m - 1)
            }
            ...
            commonNode:function (a) {
                ...
                var c = this.range, d =
                        c.startContainer, e = c.startOffset, g = c.endContainer, c = c.endOffset, g = g.nodeType == 3 || c === 0 ? g : g.childNodes[c - 1], d = b(d.nodeType == 3 || e === 0 ? d : d.childNodes[e - 1]), e = b(g);
        ...
        n("formatblock,selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript".split(","), function (a, b) {
        ...
        n("cut,copy,paste".split(","), function (a, b) {
        ...
        F(P, {init:function (a) {
            ...
            b.z && (b.x === k || b.y === k) && b.autoPos(b.width, b.height);
            ...
            if (a.autoScroll)if (o && B < 7 || S) {
                ...
                f(b.win).bind("scroll", function () {
                    var a = Z(), e = a.x - c.x, a = a.y - c.y;
                    b.pos(t(b.x) + e, t(b.y) + a, !1)
                })
            } else b.div.css("position", "fixed")
        }, pos:function (a, b, c) {
            c = l(c, !0);
            if (a !== null && (a = a < 0 ? 0 : q(a),this.div.css("left", a),c))this.x = a;
            if (b !== null && (b = b < 0 ? 0 : q(b),this.div.css("top", b),c))this.y = b;
            return this
        }, autoPos:function (a, b) {
            var c = t(a) || 0, d = t(b) || 0, e = Z();
            if (this._alignEl) {
                var g = f(this._alignEl), h = g.pos(), c = O(g[0].clientWidth / 2 - c / 2), d = O(g[0].clientHeight / 2 - d / 2);
                x = c < 0 ? h.x : h.x + c;
                y = d < 0 ? h.y : h.y + d
            } else h = I(this.doc),x = O(e.x + (h.clientWidth - c) / 2),y = O(e.y + (h.clientHeight - d) / 2);
            o && B < 7 || S || (x -= e.x,y -= e.y);
            return this.pos(x, y)
        }, remove:function () {
            var a = this;
        ...
        F(wa, P, {init:function (a) {
            function b() {
                ...
                ba && f(b).click(function (a) {
                    f(a.target).name ===
                            "img" && (j.selection(!0),j.range.selectNode(a.target),j.select())
                });
            ...
            var d = l(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData, i = location.host.replace(/:\d+/, "") !== document.domain, j = "document.open();" + (i ? 'document.domain="' + document.domain + '";' : "") + "document.close();", j = o ? ' src="javascript:void(function(){' + encodeURIComponent(j) + '}())"' : "";
            c.iframe = f('<iframe class="ke-edit-iframe" hidefocus="true" frameborder="0"' + j + "></iframe>").css("width",
                    "100%");
            ...
            if (this.designMode) {
                c = c.body;
                if (a === k)return a = b ? "<!doctype html><html>" + c.parentNode.innerHTML + "</html>" : c.innerHTML,this.beforeGetHtml && (a = this.beforeGetHtml(a)),ka && a ==
                        "<br />" && (a = ""),a;
            ...
            if (a === k)return this.textarea.val();
            this.textarea.val(a);
            return this
        }, design:function (a) {
        ...
        F(Wa, P, {init:function (a) {
            ...
            b && (d = u(b));
            (a === k ? !c.disableMode : a) ? (f("span.ke-outline", c.div).each(function () {
        ...
        F(xa, P, {init:function (a) {
            ...
            if (a.title === "-")this.div.append(f('<div class="ke-menu-separator"></div>')); else {
                var b =
                        f('<div class="ke-menu-item" unselectable="on"></div>'), c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = q(a.height), g = l(a.iconClass, "");
                this.div.append(b);
        ...
        f.colorpicker = Cb;
        F(Db, {init:function (a) {
            var b = f(a.button), c = a.fieldName || "file", d = a.url || "", e = b.val(), g = a.extraParams || {}, h = b[0].className || "", i = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
            a.afterError = a.afterError || function (a) {
                alert(a)
            };
            var j = [], m;
            for (m in g)j.push('<input type="hidden" name="' + m + '" value="' + g[m] + '" />');
            c = ['<div class="ke-inline-block ' + h + '">', a.target ? "" : '<iframe name="' + i + '" style="display:none;"></iframe>', a.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' +
                    i + '" action="' + d + '">', '<span class="ke-button-common">', j.join(""), '<input type="button" class="ke-button-common ke-button" value="' + e + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + c + '" tabindex="-1" />', a.form ? "</div>" : "</form>", "</div>"].join("");
            c = f(c, b.doc);
            b.hide();
            b.before(c);
            this.div = c;
        ...
        F(za, P, {init:function (a) {
            var b = l(a.shadowMode, !0);
            a.z = a.z || 811213;
            a.shadowMode = !1;
            za.parent.init.call(this, a);
            var c = a.title, d = f(a.body, this.doc), e = a.previewBtn, g = a.yesBtn, h = a.noBtn, i = a.closeBtn, j = l(a.showMask, !0);
            ...
            m.append(a);
            a.append(d);
            var k = f('<div class="ke-dialog-footer"></div>');
            (e || g || h) && m.append(k);
            n([
                {btn:e, name:"preview"},
                {btn:g, name:"yes"},
            ...
            this.height && a.height(t(this.height) - b.height() - k.height());
            this.div.width(this.div.width());
            this.div.height(this.div.height());
            this.mask = null;
            if (j)d = I(this.doc),this.mask = Ua({x:0, y:0, z:this.z - 1, cls:"ke-dialog-mask", width:Math.max(d.scrollWidth, d.clientWidth), height:Math.max(d.scrollHeight, d.clientHeight)});
        ...
        f.ajax = function (a, b, c, d, e) {
            var c = c || "GET", e = e || "json", g = z.XMLHttpRequest ? new z.XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
            g.open(c, a, !0);
        ...
        la.prototype = {lang:function (a) {
            ...
            c.isLoading = !0;
            Ya(c.pluginsPath + a + "/" + a + ".js?ver=" + encodeURIComponent(f.DEBUG ? Ba : Ca), function () {
                c.isLoading = !1;
            ...
            var a = this;
            n("justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,subscript,superscript,bold,italic,underline,strikethrough".split(","), function (b, c) {
            ...
            function a() {
                m.height() === 0 ? setTimeout(a, 100) : c.resize(e, g)
            }

            function b(a, b, d) {
                d = l(d,
                        !0);
                if (a && a >= c.minWidth && (c.resize(a, null),d))c.width = q(a);
                if (b && b >= c.minHeight && (c.resize(null, b),d))c.height = q(b)
            }
            ...
            if (o && B < 8 || S)g = q(t(g) + 2);
            var h = c.container = f(c.layout);
            d ? f(document.body).append(h) : c.srcElement.before(h);
            var i = f(".toolbar", h), j = f(".edit", h), m = c.statusbar = f(".statusbar", h);
            h.removeClass("container").addClass("ke-container ke-container-" +
                    c.themeType).css("width", e);
            if (d) {
                h.css({position:"absolute", left:0, top:0, "z-index":811211});
            ...
            } else c._fullscreenExecuted && (f(document.body).css({height:"", overflow:""}),f(document.body.parentNode).css("overflow", "")),c._scrollPos && z.scrollTo(c._scrollPos.x, c._scrollPos.y);
            var k = [];
            f.each(c.items, function (a, b) {
                b == "|" ? k.push('<span class="ke-inline-block ke-separator"></span>') :
                        b == "/" ? k.push('<div class="ke-hr"></div>') : (k.push('<span class="ke-outline" data-name="' + b + '" title="' + c.lang(b) + '" unselectable="on">'),k.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + b + '" unselectable="on"></span></span>'))
            });
            var i = c.toolbar = Bb({src:i, html:k.join(""), noDisableItems:c.noDisableItems, click:function (a, b) {
                a.stop();
                if (c.menu) {
                    var d = c.menu.name;
                    c.hideMenu();
                ...
                c.clickToolbar(b)
            }}), n = t(g) - i.div.height(), p = c.edit = zb({height:n > 0 && t(g) > c.minHeight ? n : c.minHeight,
                src:j, srcElement:c.srcElement, designMode:c.designMode, themesPath:c.themesPath, bodyClass:c.bodyClass, cssPath:c.cssPath, cssData:c.cssData, beforeGetHtml:function (a) {
                    a = c.beforeGetHtml(a);
            ...
            f(z).unbind("resize");
            a();
            d ? (f(z).bind("resize", function () {
                c.isCreated && b(I().clientWidth, I().clientHeight, !1)
            }),i.select("fullscreen"),m.first().css("visibility", "hidden"),m.last().css("visibility", "hidden")) : (ka && f(z).bind("scroll", function () {
                c._scrollPos = Z()
            }),c.resizeType > 0 ? Sa({moveEl:h, clickEl:m, moveFn:function (a, c, d, e, g, f) {
                e += f;
                b(null, e)
            }}) : m.first().css("visibility", "hidden"),c.resizeType === 2 ? Sa({moveEl:h, clickEl:m.last(), moveFn:function (a, c, d, e, g, f) {
                d += g;
                e += f;
                b(d, e)
            ...
            a.container.remove();
            a.container =
                    a.toolbar = a.edit = a.menu = null;
            a.dialogs = [];
            a.isCreated = !1;
            return a
        }, resize:function (a, b) {
            a !== null && t(a) > this.minWidth && this.container.css("width", q(a));
            ...
            if (a === k)return this.isCreated ? this.edit.html() : ja(this.srcElement);
            ...
            return a === k ? A(this.html().replace(/<(?!img|embed).*?>/ig, "").replace(/&nbsp;/ig, " ")) : this.html(C(a))
        }, isEmpty:function () {
            ...
            var a = a.toLowerCase(), b = this.cmd, c = L(a, "selectall,copy,paste,print".split(",")) < 0;
            ...
            appendHtml:function (a) {
                ...
                var a = l(a, !0), b = this.edit, c = b.doc.body, d = $a(c.innerHTML);
                if (a && this._undoStack.length >
                        0 && Math.abs(d.length - U(this._undoStack[this._undoStack.length - 1].html).length) < this.minChangeSize)return this;
                b.designMode && !this._firstAddBookmark ? (b = this.cmd.range,a = b.createBookmark(!0),a.html = $a(c.innerHTML),b.moveToBookmark(a)) : a = {html:d};
                ...
                this.fullscreenMode = a === k ? !this.fullscreenMode :
                        a;
                return this.remove().create()
            }, readonly:function (a) {
                var a = l(a, !0), b = this, c = b.edit, d = c.doc;
                b.designMode ? b.toolbar.disableAll(a, []) : n(b.noDisableItems, function () {
                ...
                a.selectedColor !== k ? (a.cls = "ke-colorpicker-" + this.themeType,a.noColor = this.lang("noColor"),
                        this.menu = Cb(a)) : (a.cls = "ke-menu-" + this.themeType,a.centerLineMode = !1,this.menu = Xa(a));
                return this.menu
            }, hideMenu:function () {
                this.menu.remove();
                this.menu = null;
                ...
                var b =
                        this.createDialog({width:750, title:this.lang("uploadError"), body:'<div style="padding:10px 20px;"><iframe frameborder="0" style="width:708px;height:400px;"></iframe></div>'}), b = f("iframe", b.div), c = f.iframeDoc(b);
                c.open();
                c.write(a);
                c.close();
        ...
        Gb("core",
                function (a) {
                    ...
                    n("undo,redo".split(","), function (a, d) {
                    ...
                    b.clickToolbar("formatblock", function () {
                        ...
                        n(a, function (a, e) {
                            ...
                            f.addItem({title:'<span style="' + k + '" unselectable="on">' + e + "</span>", height:c[a] + 12, checked:d === a || d === e, click:function () {
                    ...
                    b.clickToolbar("fontname", function () {
                        ...
                        n(b.lang("fontname.fontName"), function (d, f) {
                            c.addItem({title:'<span style="font-family: ' + d + ';" unselectable="on">' + f + "</span>", checked:a === d.toLowerCase() ||
                                    a === f.toLowerCase(), click:function () {
                    ...
                    b.clickToolbar("fontsize", function () {
                        ...
                        n(b.fontSizeTable, function (d, f) {
                    ...
                    n("forecolor,hilitecolor".split(","), function (a, c) {
                        b.clickToolbar(c, function () {
                            b.createMenu({name:c, selectedColor:b.cmd.val(c) ||
                                    "default", colors:b.colorTable, click:function (a) {
                                b.exec(c, a).hideMenu()
                            }})
                        })
                    });
                    n("cut,copy,paste".split(","), function (a, c) {
                        b.clickToolbar(c, function () {
                            b.focus();
                            try {
                                b.exec(c, null)
                    ...
                    b.plugin.getSelectedImage = function () {
                        return Aa(b.edit.cmd.range, function (a) {
                    ...
                    n("link,image,flash,media,anchor".split(","), function (a, c) {
                        var d = c.charAt(0).toUpperCase() + c.substr(1);
                        n("edit,delete".split(","), function (a, e) {
                            b.addContextmenu({title:b.lang(e + d), click:function () {
                                b.loadPlugin(c, function () {
                                    b.plugin[c][e]();
                                    b.hideMenu()
                                })
                            }, cond:b.plugin["getSelected" + d], width:150, iconClass:e == "edit" ? "ke-icon-" + c : k})
                        });
                    ...
                    n("prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete".split(","), function (a, c) {
                    ...
                    b.addContextmenu({title:"-"});
                    n("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","), function (a, d) {
                        c[d] && b.afterCreate(function () {
                            Ga(this.edit.doc, c[d], function () {
                                b.cmd.selection();
                                b.clickToolbar(d)
                    ...
                    b.afterCreate(function () {
                        function c() {
                            ...
                            var d = j[0].innerHTML;
                            j.remove();
                            d !== "" && (b.pasteType === 2 && (/schemas-microsoft-com|worddocument|mso-\w+/i.test(d) ? d = lb(d, b.filterMode ? b.htmlTags : a.options.htmlTags) : (d = Q(d, b.filterMode ? b.htmlTags : null),d = b.beforeSetHtml(d))),
                        ...
                        var d = b.edit.doc, f, i, j, k = "__kindeditor_paste__", l = !1;
                        a(d.body).bind("paste", function (n) {
                            if (b.pasteType === 0)n.stop(); else if (!l) {
                                ...
                                j = a('<div class="' + k + '"></div>', d).css({position:"absolute", width:"1px", height:"1px", overflow:"hidden", left:"-1981px", top:a(i.start).pos().y + "px", "white-space":"nowrap"});
                                a(d.body).append(j);
                                if (o) {
                                    var p = f.range.get(!0);
                                    p.moveToElementText(j[0]);
                                    p.select();
                                    p.execCommand("paste");
                                    n.preventDefault()
                    ...
                    b.beforeGetHtml(function (a) {
                        return a.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig,
                                ...
                                function (a) {
                                    var a = J(a), b = ea(a.style || ""), c = nb(a["data-ke-tag"]);
