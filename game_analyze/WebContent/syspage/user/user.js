...
require(['jquery', 'dialog'], function ($, dialog) {
    ...
    function adduser() {
        ...
        var htmlobjxx;
        if (uid) {
            htmlobjxx = $.ajax({url: "/sys/user/edit?uid=" + uid, cache: false, async: false});
        } else {
            htmlobjxx = $.ajax({url: "/sys/user/add", cache: false, async: false});
        }
    ...
    function shouquan() {
        ...
        d.show();
        var htmlobjxx = $.ajax({url: "/sys/user/shouquan?uid=" + uid, cache: false, async: false});
        dialog.get('demox').content(htmlobjxx.responseText);
