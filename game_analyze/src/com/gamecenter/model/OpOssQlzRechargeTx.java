...
public class OpOssQlzRechargeTx implements Serializable {
	...
	public Integer getConfirmret() {
		return confirmret;
	}
	
	public void setConfirmret(Integer confirmret) {
		this.confirmret = confirmret;
	}
	...
	public boolean equals(Object that) {
		...
		return (this.getDid() == null ? other.getDid() == null : this.getDid().equals(other.getDid())) && (this.getBillno() == null ? other.getBillno() == null : this.getBillno().equals(other.getBillno())) && (this.getOpenid() == null ? other.getOpenid() == null : this.getOpenid().equals(other.getOpenid())) && (this.getAppid() == null ? other.getAppid() == null : this.getAppid().equals(other.getAppid())) && (this.getTs() == null ? other.getTs() == null : this.getTs().equals(other.getTs())) && (this.getPayitem() == null ? other.getPayitem() == null : this.getPayitem().equals(other.getPayitem())) && (this.getToken() == null ? other.getToken() == null : this.getToken().equals(other.getToken())) && (this.getVersion() == null ? other.getVersion() == null : this.getVersion().equals(other.getVersion())) && (this.getZoneid() == null ? other.getZoneid() == null : this.getZoneid().equals(other.getZoneid())) && (this.getProvidetype() == null ? other.getProvidetype() == null : this.getProvidetype().equals(other.getProvidetype())) && (this.getAmt() == null ? other.getAmt() == null : this.getAmt().equals(other.getAmt())) && (this.getPayamtCoins() == null ? other.getPayamtCoins() == null : this.getPayamtCoins().equals(other.getPayamtCoins())) && (this.getPubacctPayamtCoins() == null ? other.getPubacctPayamtCoins() == null : this.getPubacctPayamtCoins().equals(other.getPubacctPayamtCoins())) && (this.getSig() == null ? other.getSig() == null : this.getSig().equals(other.getSig())) && (this.getAddtime() == null ? other.getAddtime() == null : this.getAddtime().equals(other.getAddtime())) && (this.getStatus() == null ? other.getStatus() == null : this.getStatus().equals(other.getStatus())) && (this.getConfirmcount() == null ? other.getConfirmcount() == null : this.getConfirmcount().equals(other.getConfirmcount())) && (this.getConfirmret() == null ? other.getConfirmret() == null : this.getConfirmret().equals(other.getConfirmret()));
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((getConfirmret() == null) ? 0 : getConfirmret().hashCode());
		return result;
	}
}