...
//		view.addObject("lists", list);
	...
	public ModelAndView rechargeFetch(HttpSession session,@RequestParam(value = "page", defaultValue = "1") int curPage) {
		...
		if (agent != null) {
			...
			view.addObject("total", pageInfo.getTotal());
			view.addObject("fetch", pageInfo.getTotal());
		}
		return view;
	}
//	
