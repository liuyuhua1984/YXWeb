...
public class LoginOutController {
	...
	@ResponseBody
	public Object loginCheck(@RequestParam("userName") String userName, @RequestParam("pwd") String pwd, @RequestParam("token") String token, @RequestParam("check") byte check, HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		String res = "-1";
